...
* Currently, most simple changes would probably end up breaking the application. And the person who, for example decides to change Amazon Bedrock (Amazon Nova Pro v1) for Flan-T5-Small would not necessarily realize that.
