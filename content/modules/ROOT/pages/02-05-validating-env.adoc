...
+
.. Run the following command to download a `.env` file that will be used by the Jupiter Notebooks to configure access to the Amazon Bedrock and Bedrock Knowledge Base services
+
...
BEDROCK_MODEL=amazon-nova-pro-v1
BEDROCK_EMBEDDING=text-embeddings
BEDROCK_KB_NAME="my-bedrock-kb"
BEDROCK_KB_INDEX_NAME="my-bedrock-kb-index"
