...
The answer you receive here will be different from what is shown below, this is because the example below was using the IBM Granite model, whereas here we're using an Amazon model served by AWS. The answers given should still be correct.
